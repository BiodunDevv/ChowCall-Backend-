...
const tenantSchema = new Schema(
  {
    ...
    voice: {
      ...
      provider: { type: String, enum: ["aws_nova_sonic", "azure_speech", "azure_voice_live"], default: "aws_nova_sonic" },
      modelId: { type: String, default: "amazon.nova-sonic-v1:0" },
      language: { type: String, default: "en-US" },
      voiceId: { type: String, default: "tiffany" },
      speakingStyle: { type: String, enum: ["friendly", "professional", "warm", "fast", "calm"], default: "friendly" },
      responseSpeed: { type: String, enum: ["normal", "fast"], default: "normal" },
      allowInterruptions: { type: Boolean, default: true },
      captionsEnabledByDefault: { type: Boolean, default: true },
